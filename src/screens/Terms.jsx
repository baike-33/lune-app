...
import { TERMS_SECTIONS as SECTIONS } from '../data/legal';
    ...
    <div style={lv3Phone(muse)}>
      ...
      <div style={{ position: 'absolute', inset: 0, overflowY: 'auto', overflowX: 'hidden' }}>
        ...
        <div style={{ padding: '16px 20px 0' }}>
          <div className="lv3-mono" style={{ fontSize: 9.5, letterSpacing: '.20em', textTransform: 'uppercase', color: m.palette.accent }}>CGU</div>
          <h1 className="lv3-serif" style={{ fontSize: 30, fontStyle: 'italic', margin: '6px 0 0', lineHeight: 1.05 }}>
            Conditions <em style={{ color: m.palette.accent }}>d'utilisation</em>
          </h1>
        </div>
        ...
        <div style={{ padding: '16px 18px 0' }}>
          <Glass tight style={{ padding: '14px 16px', border: `1px solid ${LV3.rose}66`, background: `${LV3.rose}14` }}>
            ...
            <div style={{ fontSize: 12, color: LV3.ink2, lineHeight: 1.5 }}>
              À faire relire par un professionnel du droit avant toute mise en ligne commerciale.
            </div>
          </Glass>
        </div>
